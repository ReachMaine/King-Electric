...
/* mods 
*  24Feb16 zig - dont show author on taxonomies (for porfolios specifically)
*				- dont show comment count.
*/
get_header();
					...
					<div class="col-xs-12">
						<article <?php post_class( 'post-inner' ); ?>>
							...
							<div class="meta-data">
								...
								<?php if (!is_tax()) { /*zig - dont show author for any taxonomy */?>
								...
								<?php /* <span class="meta-data__comments"><a href="<?php comments_link(); ?>"><?php buildpress_pretty_comments_number(); ?></a></span> zig */ ?>
							</div>
